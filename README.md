해당 프로젝트는 아래의 readme를 갖고 있고 출처 https://github.com/quantylab/rltrader 에 따릅니다.
이 레포지토리는 비영리 대학원 학기 프로젝트로 목적이 달성되는 즉시 삭제합니다.
동일조건 변경을 허락하며, 이용 허락권자로 부터 받은 권리는 없습니다.
어디까지나 집과 연구소 두 곳에서 코드 변경을 위해 작성한 것으로 문제가 될 시 삭제하겠습니다.
